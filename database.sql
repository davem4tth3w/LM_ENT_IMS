...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 03, 2024 at 02:03 PM
...
(27, 1, 44000.00, '2024-02-03', 'dave m', 'GUIWAN', 'cash', 'active', '2024-02-02'),
(28, 1, 550.00, '2024-02-03', 'dave mmm', 'sta. maria', 'cash', 'inactive', '2024-02-03');
...
(81, 27, 24, 5, 4000.00, 10.00),
(82, 27, 24, 5, 4000.00, 10.00),
(83, 28, 25, 1, 500.00, 10.00);
...
(24, 15, 25, 'PRINTER', 'Printing Device', 1, 'Box', 4000.00, '10.00', 0.00, 1, 'active', '2024-02-02'),
(25, 16, 26, 'Pencil', 'q3tqb4hqvq23b', 5, 'Box', 500.00, '10.00', 0.00, 1, 'active', '2024-02-03');
...
--
ALTER TABLE `inventory_order`
  MODIFY `inventory_order_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
